...
<template>
        ...
        <card>
          <template slot="header">
            <div class="row justify-content-between align-items-between mx-3">
              ...
              <div>
                  <base-button class="btn btn-primary" @click="modalApps = true">Add</base-button>
              </div>
              
              <modal :show.sync="modalApps">
                <template slot="header">
  ...
  <base-input label="CreatedDate" type="text" placeholder="Enter CreatedDate" v-model="appToAdd.createdDate"></base-input>
          ...
          <div v-if="isTableView">
            ...
            <a-table :columns="columns" :data-source="apps" :row-key="record => record.AppId" :pagination="pagination"
...
import AppPictureView from './AppPictureView.vue';
...
export default {
  ...
  data() {
    return {
      ...
      sortBy: 'appId',           // Column to sort by
  ...
  methods: {
    ...
    async renderAppsTable() {
      ...
      for (let i = 0; i < this.apps.length; i++) {
        appsTableData.push({
          id: i,
          appId: this.apps[i].appId,
          year: this.apps[i].year,
          date: this.apps[i].date,
          competitionId: this.apps[i].competitionId,
          appId: this.apps[i].appId,
        });
    ...
    async onTableChange(pagination, filters, sorter) {
	  ...
	  this.$emit('get-all-apps',this.sortBy,this.sortOrder,this.pagination.current-1,this.pagination.pageSize);
    ...
    handleSearchQueryChanged() {
    	...
    	this.$root.$emit('searchQueryForAppsChanged', this.searchQuery);
	...
	async handleAddSubmitted() {
      ...
      this.appToAdd.created = currentDate;
