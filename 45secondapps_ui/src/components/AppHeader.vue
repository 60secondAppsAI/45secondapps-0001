<template>
  <div class="app-header">
    <div>
      <router-link to="/">
    	<section class="section-1">
    		<div class="title">
				<span data-desktop-color="rgba(0,97,249,1)" style="color: rgb(0, 97, 249);">45secondapps</span>
			</div>
			<div class="subtitle">
    ...
    <div class="links">
      <nav class="nav">
	        <router-link class="link" to="/appGenerators">My AppGenerators</router-link>
