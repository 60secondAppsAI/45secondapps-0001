...
<template>
        ...
        <card>
          <template slot="header">
            <div class="row justify-content-between align-items-between mx-3">
              ...
              <div>
                  <base-button class="btn btn-primary" @click="modalTemplates = true">Add</base-button>
              </div>
              
              <modal :show.sync="modalTemplates">
                <template slot="header">
  ...
  <base-input label="Version" type="text" placeholder="Enter Version" v-model="templateToAdd.version"></base-input>
          ...
          <div v-if="isTableView">
            ...
            <a-table :columns="columns" :data-source="templates" :row-key="record => record.TemplateId" :pagination="pagination"
          ...
          <div v-else>
            ...
            <TemplatePictureView :templates="templates" />
          </div>
...
import TemplatePictureView from './TemplatePictureView.vue';
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'templateId',
          ...
          sorter: true
          //sorter: (a, b) => a.templateId - b.templateId,
      ...
      sortBy: 'templateId',           // Column to sort by
  ...
  methods: {
    ...
    async renderTemplatesTable() {
      ...
      for (let i = 0; i < this.templates.length; i++) {
        templatesTableData.push({
          id: i,
          templateId: this.templates[i].templateId,
          year: this.templates[i].year,
          date: this.templates[i].date,
          competitionId: this.templates[i].competitionId,
          templateId: this.templates[i].templateId,
        });
    ...
    async onTableChange(pagination, filters, sorter) {
	  ...
	  this.$emit('get-all-templates',this.sortBy,this.sortOrder,this.pagination.current-1,this.pagination.pageSize);
    ...
    handleSearchQueryChanged() {
    	...
    	this.$root.$emit('searchQueryForTemplatesChanged', this.searchQuery);
	...
	async handleAddSubmitted() {
      ...
      this.templateToAdd.created = currentDate;
