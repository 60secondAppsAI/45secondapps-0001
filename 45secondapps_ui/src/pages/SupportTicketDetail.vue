						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Query" type="text" placeholder="Enter Query" v-model="supportTicketToAdd.query"></base-input>
								  <base-input label="Status" type="text" placeholder="Enter Status" v-model="supportTicketToAdd.status"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Support Ticket Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Query</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Query" type="text" placeholder="Enter Query" v-model="supportTicketDetails.query"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Status</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Status" type="text" placeholder="Enter Status" v-model="supportTicketDetails.status"></input>
																		</div>
						</td>
														</tr>
