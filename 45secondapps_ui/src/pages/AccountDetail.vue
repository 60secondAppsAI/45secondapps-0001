              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Account Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Plan Type</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PlanType" type="text" placeholder="Enter PlanType" v-model="accountDetails.planType"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Start Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="accountDetails.startDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
